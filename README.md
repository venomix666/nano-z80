...
0x16:  Ink (0-15, corresponds to Fuzix terminal colors), only used in video mode 0x04  
0x17:  Paper (0-15, corresponds to Fuzix terminal colors), only used in video mode 0x04  
0x18:  Inverse, only used in video mode 0x04  
